...
const NoteikumuPage = async () => {
  ...
  return (
    <div className={'container mx-auto mt-5 px-8 xl:px-24 '}>
      ...
      <div className={'flex items-center lg:justify-between mt-8 gap-x-32 gap-y-10 flex-wrap'}>
        <div className={'flex flex-col w-full xl:w-3/12  min-h-64 gap-3 relative'}>
          ...
          <h4 className={'text-left font-bold text-lg'}>1. Vispārīgie jautājumi</h4>
